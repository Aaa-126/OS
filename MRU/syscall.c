...
extern uint64 sys_accesss(void);
extern uint64 sys_signals(void);
extern uint64 sys_get_shm(void);
extern uint64 sys_shm_close(void);
extern uint64 sys_send_msg(void);
extern uint64 sys_recv_msg(void);
extern uint64 sys_symlink(void);
extern uint64 sys_check_accessed(void);
...
[SYS_accesss]     sys_accesss,
[SYS_signals]     sys_signals,
[SYS_get_shm]    sys_get_shm,
[SYS_shm_close]  sys_shm_close,
[SYS_send_msg] sys_send_msg,
[SYS_recv_msg] sys_recv_msg,
[SYS_symlink]   sys_symlink,
[SYS_check_accessed]  sys_check_accessed,
